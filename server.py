...
# =====================================================
# 1. เชื่อมต่อ Firebase (วิธี JSON Raw String)
# =====================================================
# กุญแจดอกล่าสุด (8bd18...) ใส่แบบ JSON ดิบๆ เพื่อกัน format เพี้ยน
...
if os.path.exists(MEMORY_FILE):
    try:
        with open(MEMORY_FILE, "r") as f: ai_memory = json.load(f)
    except: pass
...
model = genai.GenerativeModel(
    ...
    tools=tools_list,
    system_instruction="คุณคือ Data Scientist AI ตอบเป็นภาษาไทย"
)
